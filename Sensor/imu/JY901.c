...
void CopeSerialData(unsigned char ucRxBuffer[])
{	
	...
	switch(ucRxBuffer[1])
		{
			...
			case 0x50:  stcTime.ucYear 		= ucRxBuffer[2];
						...
						break;
			//Acceleration
			case 0x51:	stcAcc.a[0] = ((short)ucRxBuffer[3]<<8)|ucRxBuffer[2];
						stcAcc.a[1] = ((short)ucRxBuffer[5]<<8)|ucRxBuffer[4];
						stcAcc.a[2] = ((short)ucRxBuffer[7]<<8)|ucRxBuffer[6];
						break;
			//Angular Speed
			case 0x52:	stcGyro.w[0] = ((short)ucRxBuffer[3]<<8)|ucRxBuffer[2];
			...
			case 0x53:	stcAngle.Angle[0] = (((short)ucRxBuffer[3])<<8)|ucRxBuffer[2];
						...
						break;
			//Magnet Field
			case 0x54:	stcMag.h[0] = ((short)ucRxBuffer[3]<<8)|ucRxBuffer[2];
